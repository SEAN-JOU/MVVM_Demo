...
public class LTDotLayout: NSObject {
    ...
    public convenience init(dotWidth: CGFloat = 13, dotHeight: CGFloat = 13, dotMargin: CGFloat = 15.0, dotImage: UIImage? = nil, dotSelectImage: UIImage? = nil, dotColor: UIColor = UIColor.clear, dotSelectColor: UIColor = UIColor.clear, dotType: LTAutoScrollViewType = .custom, isScale: Bool = true, scaleXY: CGFloat = 1.4) {
        self.init()
